...
type SparseFloatRow struct {
	...
	// data in indices and values must be sorted by the index
	Indices              *IntArray   `protobuf:"bytes,1,opt,name=indices,proto3" json:"indices,omitempty"`
	Values               *FloatArray `protobuf:"bytes,2,opt,name=values,proto3" json:"values,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
type SparseFloatArray struct {
	Contents []*SparseFloatRow `protobuf:"bytes,1,rep,name=contents,proto3" json:"contents,omitempty"`
...
var fileDescriptor_1c5fb4d8cc22d66a = []byte{
	...
	,
}
