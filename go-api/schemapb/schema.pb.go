...
type SparseFloatArray struct {
	...
	Dim int32 `protobuf:"varint,1,opt,name=dim,proto3" json:"dim,omitempty"`
	// nnz is the number of non-zero values of all vectors in the current batch
	Nnz                  int32             `protobuf:"varint,2,opt,name=nnz,proto3" json:"nnz,omitempty"`
	Contents             []*SparseFloatRow `protobuf:"bytes,3,rep,name=contents,proto3" json:"contents,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *SparseFloatArray) GetNnz() int32 {
	if m != nil {
		return m.Nnz
	}
	return 0
...
var fileDescriptor_1c5fb4d8cc22d66a = []byte{
	...
	,
}
