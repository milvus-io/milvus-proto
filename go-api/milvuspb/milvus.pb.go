...
type ReplicaInfo struct {
	...
	OutboundNodeIds      []int64         `protobuf:"varint,6,rep,packed,name=outbound_node_ids,json=outboundNodeIds,proto3" json:"outbound_node_ids,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (m *ReplicaInfo) GetOutboundNodeIds() []int64 {
	if m != nil {
		return m.OutboundNodeIds
	}
	return nil
}
...
type ReplicaInCollection struct {
	CollectionID         int64    `protobuf:"varint,1,opt,name=collectionID,proto3" json:"collectionID,omitempty"`
	ReplicaIDs           []int64  `protobuf:"varint,2,rep,packed,name=replicaIDs,proto3" json:"replicaIDs,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *ReplicaInCollection) Reset()         { *m = ReplicaInCollection{} }
func (m *ReplicaInCollection) String() string { return proto.CompactTextString(m) }
func (*ReplicaInCollection) ProtoMessage()    {}
func (*ReplicaInCollection) Descriptor() ([]byte, []int) {
	return fileDescriptor_02345ba45cc0e303, []int{124}
}

func (m *ReplicaInCollection) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ReplicaInCollection.Unmarshal(m, b)
}
func (m *ReplicaInCollection) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ReplicaInCollection.Marshal(b, m, deterministic)
}
func (m *ReplicaInCollection) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReplicaInCollection.Merge(m, src)
}
func (m *ReplicaInCollection) XXX_Size() int {
	return xxx_messageInfo_ReplicaInCollection.Size(m)
}
func (m *ReplicaInCollection) XXX_DiscardUnknown() {
	xxx_messageInfo_ReplicaInCollection.DiscardUnknown(m)
}

var xxx_messageInfo_ReplicaInCollection proto.InternalMessageInfo

func (m *ReplicaInCollection) GetCollectionID() int64 {
	if m != nil {
		return m.CollectionID
	}
	return 0
...
func (m *ReplicaInCollection) GetReplicaIDs() []int64 {
	if m != nil {
		return m.ReplicaIDs
	}
	return nil
...
type ResourceGroup struct {
	...
	ReplicaInCollection  []*ReplicaInCollection `protobuf:"bytes,4,rep,name=replica_in_collection,json=replicaInCollection,proto3" json:"replica_in_collection,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (m *ResourceGroup) GetReplicaInCollection() []*ReplicaInCollection {
	if m != nil {
		return m.ReplicaInCollection
	}
	return nil
}
...
type TransferNodeRequest struct {
	Base                 *commonpb.MsgBase `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty"`
	TargetResourceGroup  string            `protobuf:"bytes,2,opt,name=target_resource_group,json=targetResourceGroup,proto3" json:"target_resource_group,omitempty"`
...
func (m *TransferNodeRequest) GetNode() int64 {
	if m != nil {
		return m.Node
	}
	return 0
...
func (m *TransferCollectionRequest) Reset()         { *m = TransferCollectionRequest{} }
func (m *TransferCollectionRequest) String() string { return proto.CompactTextString(m) }
func (*TransferCollectionRequest) ProtoMessage()    {}
func (*TransferCollectionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_02345ba45cc0e303, []int{129}
}

func (m *TransferCollectionRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TransferCollectionRequest.Unmarshal(m, b)
}
func (m *TransferCollectionRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_TransferCollectionRequest.Marshal(b, m, deterministic)
}
func (m *TransferCollectionRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TransferCollectionRequest.Merge(m, src)
}
func (m *TransferCollectionRequest) XXX_Size() int {
	return xxx_messageInfo_TransferCollectionRequest.Size(m)
}
func (m *TransferCollectionRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_TransferCollectionRequest.DiscardUnknown(m)
}

var xxx_messageInfo_TransferCollectionRequest proto.InternalMessageInfo

func (m *TransferCollectionRequest) GetBase() *commonpb.MsgBase {
	if m != nil {
		return m.Base
	}
	return nil
...
func (m *TransferCollectionRequest) GetTargetResourceGroup() string {
	if m != nil {
		return m.TargetResourceGroup
	}
	return ""
...
func (m *TransferCollectionRequest) GetCollectionID() int64 {
	if m != nil {
		return m.CollectionID
	}
	return 0
...
type TransferReplicaRequest struct {
	Base                 *commonpb.MsgBase `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty"`
	TargetResourceGroup  string            `protobuf:"bytes,2,opt,name=target_resource_group,json=targetResourceGroup,proto3" json:"target_resource_group,omitempty"`
	ReplicaID            int64             `protobuf:"varint,3,opt,name=replicaID,proto3" json:"replicaID,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *TransferReplicaRequest) GetReplicaID() int64 {
	if m != nil {
		return m.ReplicaID
	}
	return 0
...
type ListResourceGroupResponse struct {
	Status               *commonpb.Status `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"`
	ResouseGroups        []string         `protobuf:"bytes,2,rep,name=resouse_groups,json=resouseGroups,proto3" json:"resouse_groups,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *ListResourceGroupResponse) GetResouseGroups() []string {
	if m != nil {
...
type DescribeResourceGroupResponse struct {
	Status               *commonpb.Status `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"`
	ResouseGroup         *ResourceGroup   `protobuf:"bytes,2,opt,name=resouse_group,json=resouseGroup,proto3" json:"resouse_group,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *DescribeResourceGroupResponse) GetResouseGroup() *ResourceGroup {
	if m != nil {
		return m.ResouseGroup
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*ReplicaInCollection)(nil), "milvus.proto.milvus.ReplicaInCollection")
	...
	proto.RegisterType((*TransferCollectionRequest)(nil), "milvus.proto.milvus.TransferCollectionRequest")
	proto.RegisterType((*TransferReplicaRequest)(nil), "milvus.proto.milvus.TransferReplicaRequest")
	proto.RegisterType((*ListResourceGroupRequest)(nil), "milvus.proto.milvus.ListResourceGroupRequest")
	proto.RegisterType((*ListResourceGroupResponse)(nil), "milvus.proto.milvus.ListResourceGroupResponse")
...
var fileDescriptor_02345ba45cc0e303 = []byte{
	...
	,
}
...
type MilvusServiceClient interface {
	...
	TransferCollection(ctx context.Context, in *TransferCollectionRequest, opts ...grpc.CallOption) (*commonpb.Status, error)
	ListResourceGroup(ctx context.Context, in *ListResourceGroupRequest, opts ...grpc.CallOption) (*ListResourceGroupResponse, error)
...
func (c *milvusServiceClient) TransferCollection(ctx context.Context, in *TransferCollectionRequest, opts ...grpc.CallOption) (*commonpb.Status, error) {
	out := new(commonpb.Status)
	err := c.cc.Invoke(ctx, "/milvus.proto.milvus.MilvusService/TransferCollection", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *milvusServiceClient) ListResourceGroup(ctx context.Context, in *ListResourceGroupRequest, opts ...grpc.CallOption) (*ListResourceGroupResponse, error) {
	out := new(ListResourceGroupResponse)
	err := c.cc.Invoke(ctx, "/milvus.proto.milvus.MilvusService/ListResourceGroup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MilvusServiceServer interface {
	...
	TransferCollection(context.Context, *TransferCollectionRequest) (*commonpb.Status, error)
	ListResourceGroup(context.Context, *ListResourceGroupRequest) (*ListResourceGroupResponse, error)
...
func (*UnimplementedMilvusServiceServer) TransferCollection(ctx context.Context, req *TransferCollectionRequest) (*commonpb.Status, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TransferCollection not implemented")
}
func (*UnimplementedMilvusServiceServer) ListResourceGroup(ctx context.Context, req *ListResourceGroupRequest) (*ListResourceGroupResponse, error) {
...
func _MilvusService_TransferCollection_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TransferCollectionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MilvusServiceServer).TransferCollection(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/milvus.proto.milvus.MilvusService/TransferCollection",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MilvusServiceServer).TransferCollection(ctx, req.(*TransferCollectionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _MilvusService_ListResourceGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListResourceGroupRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MilvusServiceServer).ListResourceGroup(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/milvus.proto.milvus.MilvusService/ListResourceGroup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MilvusServiceServer).ListResourceGroup(ctx, req.(*ListResourceGroupRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _MilvusService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TransferCollection",
			Handler:    _MilvusService_TransferCollection_Handler,
		},
		{
			MethodName: "ListResourceGroup",
			Handler:    _MilvusService_ListResourceGroup_Handler,
		},
		{
